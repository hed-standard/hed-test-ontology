 ...
 * [hed.yml](hed.yml)
     * Determines how your purl.obolibrary.org/obo/hed/ redirects will be handled
     ...
     * Paste in the contents of [hed.yml](hed.yml)
 ...
 * [hed.md](hed.md)
     ...
     * Paste in the contents of [hed.md](hed.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
